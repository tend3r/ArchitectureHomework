...
namespace OilPastelChoise
{
    class ConsoleUI
    {
        private PickTheCreamCollection oilPastels;

        public ConsoleUI()
        {
            oilPastels = new PickTheCreamCollection();
        }
        ...
        private void PrintItem(PickCream item)
        {
        ...
        private List<PickCream> FindForBrand()
        {
            return oilPastels.FindForBrand(GetAnswer("Бренд: "));
        }

        private List<PickCream> FindFofUserLevel()
        {
            return oilPastels.FindFofUserLevel(GetAnswer("Уровень пользователя: "));
        }

        private List<PickCream> FindForColorNumber()
        {
            int colorNumber;
        ...
        private List<PickCream> FindForPrice()
        {
            int minPrice;
